...
from embedding_system.snippet_bounds import SnippetBounds
...
class EmbeddingSystem:
    ...
    @classmethod
    def handle_user_query(cls, embedding_dim, query, limit=100):#search_by_name_flag, exactly_flag, limit=100):
